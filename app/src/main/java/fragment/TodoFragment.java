...
public class TodoFragment extends LazyFragment implements ItodoTask {
    ...
    protected void initView(View view) {
        ...
        mRecy = (XRecyclerView) view.findViewById(R.id.TodoFragment_recyclerView);
        mDoneBtn = (TextView) view.findViewById(R.id.TodoFragment_btn_done);
        mEmptyView = view.findViewById(R.id.TodoFragment_empty_view);
    ...
    public void onSuccess(List<AVObject> list, int type) {//type 0-待办 1-已完成
        switch (type) {
            case 0:
                mList.addAll(list);
                setCount(mTodoCount, String.valueOf(mList.size()), R.color.colorAccent);
